...
function loadModule(fullModulePath, page = 1) {
    ...
    switch(module) {
        case 'dashboard':
            ...
            return;
        case 'customers': url = "adminView/viewCustomers.php"; break;
        case 'mobile-clients': url = "adminView/listCustomers.php"; break;
        case 'messages': url = "adminView/viewMassages.php"; break;
        case 'inquiries': url = "adminView/showUserInquiries.php"; break;
        case 'categories': url = "adminView/viewCategories.php"; break;
        case 'main-categories': url = "adminView/showMainCategory.php"; break;
        case 'sub-categories': url = "adminView/showSubCategory.php"; break;
        case 'sizes': url = "adminView/viewSizes.php"; break;
        case 'stock': url = "adminView/showquantity.php"; break;
        case 'new-arrivals': url = "adminView/viewAllProducts.php"; break;
        case 'festivals': url = "adminView/showFestivalDhamaka.php"; break;
        case 'special-offers': url = "adminView/showSpecialOffer.php"; break;
        case 'bumper-offer': url = "adminView/showBumperOffer.php"; break;
        case 'bumper-products': url = "adminView/manageBumperProducts.php"; break;
        case 'gif-banners': url = "adminView/showGifBanner.php"; break;
        case 'hero-slider': url = "adminView/viewHeroSlider.php"; break;
        case 'payments': url = "adminView/showPayment.php"; break;

        case 'pricing': url = "adminView/pricing-status.php"; break;
        case 'our-shop': url = "adminView/viewMen.php"; break;
        case 'sub-shop': url = "adminView/showOurSubShopCollections.php"; break;
        case 'collections': url = "adminView/viewOurCollections.php"; break;
        case 'sub-collections': url = "adminView/viewOurSubCollections.php"; break;
        default:
            content.html($("#dashboardContent").html());
            return;
    }
...
function showMainCategory() { loadModule('main-categories'); }
function showSubCategory() { loadModule('sub-categories'); }
function showCategory() { loadModule('categories'); }
function showProductItems() { loadModule('new-arrivals'); }
