...
class FPDF
{
	...
	protected $n = 2;
	/** @var array<int, int> array of object offsets */
	protected $offsets = array();
	/** @var string buffer holding in-memory PDF */
	protected $buffer = '';
	/** @var array<int, string> array containing pages */
	...
	/** @var array<string, array{0: float, 1: float}> standard page sizes */
	protected $StdPageSizes;
	/** @var array{0: float, 1: float} default page size */
	protected $DefPageSize;
	/** @var array{0: float, 1: float} current page size */
	protected $CurPageSize;
	/** @var int current page rotation */
	protected $CurRotation;
	/** @var array<int, array<string, mixed>> page-related data */
	protected $PageInfo = array();
	/** @var float dimensions of current page in points */
	protected $wPt, $hPt;
	/** @var float dimensions of current page in user unit */
	protected $w, $h;
	...
	protected $cMargin;
	/** @var float current position in user unit */
	protected $x, $y;
	...
	protected $fontpath = '';
	/** @var array<string, string> array of core font names */
	protected $CoreFonts;
	/** @var array<int|string, array<string, mixed>> array of used fonts */
	protected $fonts = array();
	/** @var array<string, array<string, mixed>> array of font files */
	protected $FontFiles = array();
	/** @var array<string, int> array of encodings */
	protected $encodings = array();
	/** @var array<string, int> array of ToUnicode CMaps */
	...
	protected $underline;
	/** @var array<string, mixed>|null current font info */
	...
	protected $ws = 0;
	/** @var array<string, array<string, mixed>> array of used images */
	protected $images = array();
	/** @var array<int, list<array<int, mixed>>> */
...
/**
 * Defines the ordinate of the current position and resets the abscissa
 * @param float $y
 * @param bool $resetX
 */
...
/**
 * Add a line to the document buffer
 * @param string $s
 */
 ...
 * @param array<int, int|array{0: int, 1: int}> $uv
 * @return string
 */
